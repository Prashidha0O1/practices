export class UserAgentGenerator {
  ...
  private static readonly FIREFOX_VERSIONS = [
    '121.0', '120.0', '119.0', '118.0', '117.0'
  ];
  
  private static readonly SAFARI_VERSIONS = [
    '17.1', '17.0', '16.6', '16.5', '16.4'
  ];
  
  private static readonly EDGE_VERSIONS = [
    '120.0.0.0', '119.0.0.0', '118.0.0.0', '117.0.0.0', '116.0.0.0'
  ];

  static generateChromeUserAgent(platform: string = 'desktop'): string {
  ...
  static generateFirefoxUserAgent(platform: string = 'desktop'): string {
  ...
  static generateSafariUserAgent(platform: string = 'desktop'): string {
  ...
  static generateEdgeUserAgent(): string {
  ...
  static getPlatformFromUserAgent(userAgent: string): string {
